...
#Purpose: Find correlation, for lag 1 AR(1) data via the corr plot and also by the Runs test
# Valid for nonnormal data 
...
#if n.pos < 20 or n.neg  <20 use the table, approx wont be nice. 
...
#if x > Zalpha/2 corr exists and cannot be rejected 
